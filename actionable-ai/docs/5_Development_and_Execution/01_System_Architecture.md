...
graph TD
    subgraph Presentation Layer
        L[Public Landing Page (Next.js/React)]
        W[Embeddable Widget (Web Component)]
        D[B2B Dashboard (React/Vite)]
    end
...
- **Public Landing Page:** Built with React (Next.js/Vite) to serve as the marketing site, converting visitors and routing them to the Dashboard authentication flow.
- **B2B Dashboard:** Built with React 18, Vite, and strict Enterprise CSS (flat design, no gradients). Used by administrators to upload documents and register API tools.
